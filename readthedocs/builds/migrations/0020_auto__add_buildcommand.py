...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BuildCommand'
        db.create_table(u'builds_buildcommand', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('build', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commands', to=orm['builds.Build'])),
    ...
    def backwards(self, orm):
        # Deleting model 'BuildCommand'
        db.delete_table(u'builds_buildcommand')
